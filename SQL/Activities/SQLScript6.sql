...
select order_no from orders where order by order_date;

select order_no from orders where order by order_date;

select order_no from orders where orders order by order_date;
...
select * from orders where purchase_amount < 1000 or purchase_amount > 2000;
